...
void main() => runApp(StateControlledByProxyProviderApp());

class StateControlledByProxyProviderApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text(
            'State Controlled By Proxy Provide App',
          ),
        ),
        body: MultiProvider(
          providers: [
